...
/**
 * This is the item provider adapter for a {@link org.eventb.emf.core.EventBPredicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventBPredicateItemProvider
	 ...
	 * @generated
	 */
	public EventBPredicateItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((EventBPredicate)object).getPredicate();
		return label == null || label.length() == 0 ?
			getString("_UI_EventBPredicate_type") :
			getString("_UI_EventBPredicate_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventBPredicate.class)) {
