...
public class ExtensionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_extensionId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_extensionId_feature", "_UI_Extension_type"),
				 CorePackage.Literals.EXTENSION__EXTENSION_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Extension)object).getExtensionId();
