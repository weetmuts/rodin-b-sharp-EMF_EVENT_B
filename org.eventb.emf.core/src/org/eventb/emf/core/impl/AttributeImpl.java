 ...
 * <ul>
 *   <li>{@link org.eventb.emf.core.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eventb.emf.core.impl.AttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeImpl extends EventBObjectImpl implements Attribute {
	/**
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ATTRIBUTE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.ATTRIBUTE__TYPE:
				return getType();
			case CorePackage.ATTRIBUTE__VALUE:
				return getValue();
		}
