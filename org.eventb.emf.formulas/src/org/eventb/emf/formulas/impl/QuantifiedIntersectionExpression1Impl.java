...
public class QuantifiedIntersectionExpression1Impl extends BExpressionResolvedImpl implements QuantifiedIntersectionExpression1 {
		...
		if (predicate != null && predicate.eIsProxy()) {
			...
			if (predicate != oldPredicate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormulasPackage.QUANTIFIED_INTERSECTION_EXPRESSION1__PREDICATE, oldPredicate, predicate));
			}
		}
		return predicate;
	}
	...
	public void setPredicate(BPredicateResolved newPredicate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormulasPackage.QUANTIFIED_INTERSECTION_EXPRESSION1__PREDICATE, oldPredicate, predicate));
	}
	...
	public BExpressionResolved getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormulasPackage.QUANTIFIED_INTERSECTION_EXPRESSION1__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(BExpressionResolved newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormulasPackage.QUANTIFIED_INTERSECTION_EXPRESSION1__EXPRESSION, oldExpression, expression));
	}
