 ...
 * <ul>
 *   <li>{@link ac.soton.eventb.emf.core.extension.coreextension.impl.TypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends EObjectImpl implements Type {
	...
	protected EClass eStaticClass() {
		return CoreextensionPackage.Literals.TYPE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoreextensionPackage.TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoreextensionPackage.TYPE__TYPE:
				return getType();
		}
