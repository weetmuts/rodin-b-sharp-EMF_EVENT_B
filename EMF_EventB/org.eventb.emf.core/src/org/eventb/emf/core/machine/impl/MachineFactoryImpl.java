...
public class MachineFactoryImpl extends EFactoryImpl implements MachineFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MachinePackage.VARIABLE: return createVariable();
			case MachinePackage.INVARIANT: return createInvariant();
			case MachinePackage.VARIANT: return createVariant();
			case MachinePackage.EVENT: return createEvent();
			case MachinePackage.PARAMETER: return createParameter();
			case MachinePackage.GUARD: return createGuard();
	 ...
	 * @generated
	 */
	public String convertConvergenceToString(EDataType eDataType, Object instanceValue) {
