...
public interface CorePackage extends EPackage {
	...
	/**
	 * A dummy URI used for constructing proxies until the proper URI is available
	 * Typically, the dummy URI is used to store a fragment referencing an element name
	 * which may be contained within a resource or be the name of the resource itself.
